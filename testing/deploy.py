...
def run(logger, local_properties):
	keycloak_master_url = "http://localhost:8080/"
	...
	master_admin = SherpaKeycloakAdmin(logger=logger, local_properties=local_properties, server_url=keycloak_master_url, username=keycloak_user, password=keycloak_password)
	...
	custom_admin = SherpaKeycloakAdmin(logger=logger, local_properties=local_properties, server_url=keycloak_master_url, username=keycloak_user, password=keycloak_password, user_realm_name="master", realm_name=custom_realm)
